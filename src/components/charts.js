...
export function top5BalancingAuthoritiesChart1(width, height, top5Demand, maxDemand) {
  return Plot.plot({
    marginTop: 8,
    marginLeft: 50,
    height: height - 4,
    ...
    x: {label: null, grid: true, tickSize: 0, tickPadding: 2, domain: [0, maxDemand / 100], nice: true},
    marks: [
...
// Top 5 balancing authorities chart
export function top5BalancingAuthoritiesChart2(width, height, top5Demand, maxDemand) {
  return Plot.plot({
    marginTop: 8,
    marginLeft: 50,
    height: height - 4,
...
// Top 5 balancing authorities chart
export function top5BalancingAuthoritiesChart3(width, height, top5Demand, maxDemand) {
  return Plot.plot({
    marginTop: 8,
    marginLeft: 50,
    height: height - 4,
    width,
    y: {label: null, tickSize: 0},
    x: {label: null, grid: true, tickSize: 0, tickPadding: 2, domain: [0, maxDemand], nice: true},
    marks: [
      Plot.barX(top5Demand, {
        y: "name",
        x: (d) => d.value,
